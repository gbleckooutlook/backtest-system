<template>
  <div>
    <div style="display: flex; align-items: center; margin-bottom: 2rem;">
      ...
      />
      <h1 style="font-size: 2rem; font-weight: bold; color: #2c3e50; margin: 0;">Criar Ativo</h1>
    </div>
      ...
      <template #content>
        <form @submit.prevent="salvarAtivo">
          <div style="margin-bottom: 1.5rem;">
            <label for="nome" style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Nome do Ativo *</label>
            <InputText 
              id="nome" 
              v-model="form.nome" 
              style="width: 100%;"
            ...
            />
            <small v-if="submitted && !form.nome" style="color: #e24c4c; font-size: 0.875rem;">Nome é obrigatório</small>
          </div>

          <div style="margin-bottom: 1.5rem;">
            <label for="mercado" style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Mercado *</label>
            <Dropdown 
              id="mercado" 
            ...
            />
            <small v-if="submitted && !form.mercado" style="color: #e24c4c; font-size: 0.875rem;">Mercado é obrigatório</small>
          </div>

          <div style="margin-bottom: 1.5rem;">
            <label for="codigo" style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Código *</label>
            <InputText 
              id="codigo" 
              v-model="form.codigo" 
              style="width: 100%;"
            ...
            />
            <small v-if="submitted && !form.codigo" style="color: #e24c4c; font-size: 0.875rem;">Código é obrigatório</small>
          </div>

          <div style="margin-bottom: 1.5rem;">
            <label for="timeframe" style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Timeframe *</label>
            <Dropdown 
              id="timeframe" 
            ...
            />
            <small v-if="submitted && !form.timeframe" style="color: #e24c4c; font-size: 0.875rem;">Timeframe é obrigatório</small>
          </div>

          <div style="margin-bottom: 1.5rem;">
            <label for="csv" style="display: block; font-weight: 600; margin-bottom: 0.5rem;">Arquivo CSV</label>
            <input
              type="file"
              id="csv"
              accept=".csv"
